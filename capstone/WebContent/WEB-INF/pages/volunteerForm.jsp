...
<body>
<<<<<<< HEAD:capstone/WebContent/volunteerForm.jsp
<div class="gd-signup-title">Signup</div>

<mvc:form modelAttribute="Person" action="formSubmission.mvc">
...
>>>>>>> origin/master:capstone/WebContent/WEB-INF/pages/volunteerForm.jsp
